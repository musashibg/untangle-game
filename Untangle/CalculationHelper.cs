...
namespace Untangle
{
    ...
    public static class CalculationHelper
    {
        ...
        public static bool CheckLinesIntersect(
            ...
            Point endpointB2)
        {
            double orientedArea1 = CalculateTriangleOrientedArea(
                endpointA1,
                endpointA2,
                endpointB1);
            double orientedArea2 = CalculateTriangleOrientedArea(
                endpointA1,
                endpointA2,
                endpointB2);
            ...
            double orientedArea3 = CalculateTriangleOrientedArea(
                endpointB1,
                endpointB2,
                endpointA1);
            double orientedArea4 = CalculateTriangleOrientedArea(
                endpointB1,
                endpointB2,
                endpointA2);
        ...
        private static double CalculateTriangleOrientedArea(
            Point vertex1,
            Point vertex2,
            Point vertex3)
        {
